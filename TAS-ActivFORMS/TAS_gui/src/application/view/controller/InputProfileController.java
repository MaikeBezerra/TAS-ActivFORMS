...
public class InputProfileController implements Initializable {
	...
	private void initializeReqTable(){
		...
		reqTableView.getColumns().add(invocationsColumn);
		reqTableView.getColumns().add(nameColumn);
		reqTableView.getColumns().add(typeColumn);
		reqTableView.getColumns().add(dataColumn);
	}
	...
	private void initializeValueTable(){
		...
		valueTableView.getColumns().add(nameColumn);
		valueTableView.getColumns().add(typeColumn);
		valueTableView.getColumns().add(valueColumn);
		valueTableView.getColumns().add(ratioColumn);
	}
