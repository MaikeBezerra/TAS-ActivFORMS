...
public class ServiceProfileController implements Initializable {
	...
	private void setServiceProfileTable(){
       ...
       Callback<TableColumn<AttributeEntry, String>, TableCell<AttributeEntry, String>> cellFactory =
		...
		serviceProfileTable.getColumns().add(invocationsColumn);
		serviceProfileTable.getColumns().add(nameColumn);
		serviceProfileTable.getColumns().add(typeColumn);
		serviceProfileTable.getColumns().add(valueColumn);
	...
	public void setPropertyTable(){
		...
		propertyTable.getColumns().add(typeColumn);
